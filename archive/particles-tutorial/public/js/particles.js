...
function moveParticle2() {
    ...
    erease();
    // Initial positon
    var posX = 20, posY = _canvas.height / 2;
    // Initial velocities
...
function erease() {
    ...
    _context.fillRect(0, 0, _canvas.width, _canvas.height);
    //Kill intervall
    for (var _i = 0, refreshIntervalIds_1 = refreshIntervalIds; _i < refreshIntervalIds_1.length; _i++) {
        var refreshIntervalId = refreshIntervalIds_1[_i];
